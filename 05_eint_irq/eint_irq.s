	...
	IMPORT	Handle_EINT0	 	;Handle_EINT0定义在c源文件中
	IMPORT	Handle_EINT1		;Handle_EINT1定义在c源文件中
 	IMPORT	Handle_EINT2		;Handle_EINT2定义在c源文件中
 	IMPORT	Handle_EINT4_7		;Handle_EINT4_7定义在c源文件中
...
IRQ_Vecotr                            		;中断向量表
EINT0_Handle       B   Handle_EINT0 		
EINT1_Handle       B   Handle_EINT1
EINT2_Handle       B   Handle_EINT2
EINT3_Handle       B   Default_IRQ_ISR		;B   Default_IRQ_ISR代表啥都不干(因为上面对Default_IRQ_ISR中的操作定义就是啥都没干)
EINT4_7_Handle     B   Handle_EINT4_7
...
ISR_UART0_Handle   B   Default_IRQ_ISR		;收到ISR_UART0_Handle中断会跳转到Handle_UART0进行处理
